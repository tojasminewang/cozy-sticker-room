  ...
  rooms: [
    {
      ...
      stickers: [
        ...
        { id: 'lamp',      art: 'lamp',      name: 'Glow Lamp',      x: 322, y: 408, scale: 0.95, z: 2, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        { id: 'kettle',     art: 'kettle',     name: 'Tea Kettle',   x: 130, y: 437, scale: 0.95, z: 2, shadow: false },
        { id: 'toaster',    art: 'toaster',    name: 'Happy Toast',  x: 300, y: 446, scale: 0.95, z: 2, shadow: false },
        { id: 'fruitbowl',  art: 'fruitbowl',  name: 'Fruit Friends',x: 428, y: 449, scale: 0.95, z: 3, shadow: false },
        { id: 'spiceshelf', art: 'spiceshelf', name: 'Spice Shelf',  x: 615, y: 152, scale: 1.2,  z: 1, shadow: false },
        { id: 'clock',      art: 'clock',      name: 'Tick-Tock',    x: 515, y: 125, scale: 1.0,  z: 1, shadow: false },
        { id: 'herb',       art: 'herb',       name: 'Baby Basil',   x: 110, y: 320, scale: 0.8,  z: 2, shadow: false },
        ...
        { id: 'mugrack',    art: 'mugrack',    name: 'Mug Rack',     x: 300, y: 386, scale: 0.85, z: 1, shadow: false },
        { id: 'fryingpan',  art: 'fryingpan',  name: 'Frying Pan',   x: 205, y: 406, scale: 0.9,  z: 1, shadow: false },
        { id: 'milkcarton', art: 'milkcarton', name: 'Milk Carton',  x: 215, y: 448, scale: 0.85, z: 2, shadow: false },
      ],
    },
    {
      id: 'nook',
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'cafemug',    art: 'cafemug',    name: 'Cozy Latte',   x: 575, y: 540, scale: 0.9,  z: 2, shadow: false },
        { id: 'croissant',  art: 'croissant',  name: 'Croissant',    x: 640, y: 552, scale: 0.9,  z: 3, shadow: false },
        { id: 'menuboard',  art: 'menuboard',  name: 'Menu Board',   x: 510, y: 235, scale: 1.05, z: 1, shadow: false },
        { id: 'trailplant', art: 'trailplant', name: 'Ivy Hook',     x: 600, y: 230, scale: 1.0,  z: 1, shadow: false },
        { id: 'cupstack',   art: 'cupstack',   name: 'Cup Tower',    x: 415, y: 498, scale: 0.9,  z: 2, shadow: false },
        { id: 'latteart',   art: 'latteart',   name: 'Latte Print',  x: 600, y: 390, scale: 0.95, z: 1, shadow: false },
        { id: 'donutplate', art: 'donutplate', name: 'Donut Plate',  x: 214, y: 512, scale: 0.7,  z: 2, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        { id: 'desklamp',    art: 'desklamp',    name: 'Study Lamp',  x: 500, y: 442, scale: 0.95, z: 2, shadow: false },
        { id: 'laptop',      art: 'laptop',      name: 'Lil Laptop',  x: 620, y: 445, scale: 0.95, z: 2, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        { id: 'canvasart',   art: 'canvasart',   name: 'Rainbow Art',  x: 540, y: 540, scale: 1.2,  z: 2, shadow: false },
        ...
        { id: 'brushjar',    art: 'brushjar',    name: 'Brush Jar',    x: 120, y: 425, scale: 0.95, z: 2, shadow: false },
        { id: 'painttubes',  art: 'painttubes',  name: 'Paint Tubes',  x: 240, y: 435, scale: 0.95, z: 2, shadow: false },
        { id: 'swatchboard', art: 'swatchboard', name: 'Swatches',     x: 390, y: 205, scale: 1.05, z: 1, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'tambourine', art: 'tambourine', name: 'Tambourine', x: 300, y: 425, scale: 0.9,  z: 1, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'handheld',    art: 'handheld',    name: 'Handheld',     x: 628, y: 517, scale: 0.85, z: 2, shadow: false },
        ...
        { id: 'trophy',      art: 'trophy',      name: 'Mini Trophy',  x: 470, y: 517, scale: 0.8,  z: 2, shadow: false },
      ],
    },
    {
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'birdy',        art: 'birdy',        name: 'Birdy',       x: 450, y: 385, scale: 0.8,  z: 2, shadow: false },
        { id: 'windchime',    art: 'windchime',    name: 'Wind Chime',  x: 613, y: 90,  scale: 0.95, z: 1, shadow: false },
        ...
        { id: 'birdfeeder',   art: 'birdfeeder',   name: 'Bird Feeder', x: 100, y: 85,  scale: 0.9,  z: 1, shadow: false },
        { id: 'telescope',    art: 'telescope',    name: 'Telescope',   x: 648, y: 724, scale: 1.0,  z: 2, shadow: true  },
        { id: 'succulents',   art: 'succulents',   name: 'Succulents',  x: 80,  y: 388, scale: 0.8,  z: 2, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'starbunting', art: 'starbunting', name: 'Star Flags',   x: 490, y: 138, scale: 1.15, z: 1, shadow: false },
        { id: 'owl',         art: 'owl',         name: 'Owl Buddy',    x: 200, y: 160, scale: 0.85, z: 2, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'stockings',     art: 'stockings',     name: 'Stockings',    x: 478, y: 373, scale: 0.9,  z: 2, shadow: false },
        { id: 'cocoamug',      art: 'cocoamug',      name: 'Hot Cocoa',    x: 472, y: 278, scale: 0.85, z: 2, shadow: false },
        { id: 'snowglobe',     art: 'snowglobe',     name: 'Snow Globe',   x: 605, y: 280, scale: 0.85, z: 2, shadow: false },
