  ...
  rooms: [
    {
      ...
      stickers: [
        ...
        { id: 'lamp',      art: 'lamp',      name: 'Glow Lamp',      x: 387, y: 494, scale: 0.95, z: 2, shadow: false },
    ...
    },
    {
      ...
      stickers: [
        ...
        { id: 'spiceshelf', art: 'spiceshelf', name: 'Spice Shelf',  x: 470, y: 298, scale: 1.2,  z: 1, shadow: false },
        { id: 'clock',      art: 'clock',      name: 'Tick-Tock',    x: 470, y: 158, scale: 1.0,  z: 1, shadow: false },
        { id: 'herb',       art: 'herb',       name: 'Baby Basil',   x: 110, y: 200, scale: 0.8,  z: 2, shadow: false },
